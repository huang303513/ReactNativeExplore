...
@interface RNSCategoryCollectionViewCell ()
...
- (void)setupView{
  ...
  self.titleLabel = [RNSCategoryCollectionViewCell configLabelWithFont:[UIFont boldSystemFontOfSize:14] color:[UIColor blackColor] textAlign:NSTextAlignmentLeft];
  [self.placeView addSubview:self.titleLabel];
  
  self.discountPriceLabel = [RNSCategoryCollectionViewCell configLabelWithFont:[UIFont boldSystemFontOfSize:14] color:[UIColor redColor] textAlign:NSTextAlignmentLeft];
  [self.placeView addSubview:self.discountPriceLabel];
  
  self.originPriceLabel = [RNSCategoryCollectionViewCell configLabelWithFont:[UIFont systemFontOfSize:12] color:RGBColorHex(0x333333) textAlign:NSTextAlignmentLeft];
  [self.placeView addSubview:self.originPriceLabel];
  
  self.awardLabel = [RNSCategoryCollectionViewCell configLabelWithFont:[UIFont systemFontOfSize:12] color:[UIColor redColor] textAlign:NSTextAlignmentRight];
  [self.placeView addSubview:self.awardLabel];
  
  self.soldCountLabel = [RNSCategoryCollectionViewCell configLabelWithFont:[UIFont systemFontOfSize:12] color:RGBColorHex(0x333333) textAlign:NSTextAlignmentRight];;
